...
namespace AspInANetStoreFrontEndWithAuthentication.Controllers
{
    public class AccountsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Username,PasswordHash,Salt,DateJoined")] Account account)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Username,PasswordHash,Salt,DateJoined")] Account account)
        {
            if (ModelState.IsValid)
            {
